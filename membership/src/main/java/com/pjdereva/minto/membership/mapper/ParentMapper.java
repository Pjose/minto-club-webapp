...
public interface ParentMapper {
    ...
    @Mapping(target = "dob", source = "parent.person.dob")
    @Mapping(target = "lifeStatus", source = "parent.person.lifeStatus")
    @Mapping(target = "createdAt", source = "parent.person.createdAt")
    @Mapping(target = "updatedAt", source = "parent.person.updatedAt")
