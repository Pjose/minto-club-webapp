    ...
    return (
        <>
            <div className="activity-panel" style={{ height: '100%' }}>
                <p className="h5 text-black ms-4 ms-md-2"><strong>Users List</strong></p>
                <AllUsersGrid defaultPageSize={5} />
            </div>
            <div className="activity-panel" style={{ height: '100%' }}>
                <p className="h5 text-danger ms-4 ms-md-2"><strong>Members List</strong></p>
                <AllMembersGrid defaultPageSize={5} />
            </div>
            <div className="activity-panel" style={{ height: '100%' }}>
                <p className="h5 text-primary ms-4 ms-md-2"><strong>Applications List</strong></p>
                <AllApplicationsGrid defaultPageSize={5} />
            </div>
            <div className="activity-panel" style={{ height: '100%' }}>
                <p className="h5 text-info ms-4 ms-md-2"><strong>People List</strong></p>
