...
import { ArrowLeftCircleFill, ArrowRightCircleFill, EnvelopeAt, EnvelopeFill, Floppy2, GeoAlt, 
    Heart, People, PeopleFill, Person, PersonArmsUp, PersonCheck, PersonCheckFill, PersonCircle, 
    PersonFill, PersonHeart, PersonHearts, PersonLinesFill, Plus, Send, SendCheck, Telephone, 
    Trash, XCircleFill } from 'react-bootstrap-icons';
        ...
        const loadApplications = async () => {
            ...
            try {
                if(user) {
                    ...
                    if(applicationsData.id) // Only set formData if a draft application exists
                ...
                <>
                    ...
                    <div className={`card my-3 border ${cardBorderColor} shadow-lg`}> 
                        <div className={`card-header text-white ${headerBgColor}`}>
                            <h5 className="card-title">{title}: {formData.applicationNumber}</h5>
                        </div>
                        {/* New Progress Bar */}
                        <div className='card-body px-1 px-sm-3'>
                    ...
                    <div className="card-footer">
                        <div className="text-center my-2">
                            ...
                            <button type="submit" onClick={(e) => onSave(e)} className="btn btn-primary mx-3" disabled={loading} title='Save Membership Application'>
                            ...
                            {currentStep < (steps.length) ? (
                                ...
                                <>
                                    <button type="submit" onClick={(e) => onSubmit(e)} className="btn btn-success mx-3" disabled={loading} title='Submit Membership Application'>
                                        <span className="d-none d-sm-inline-block">
