...
const PersonForm = (props) => {
    ...
    let person = {};
    let extraFields = {};
    let e = { person: { ...personErrors.person()} }
    
    switch (arrayName) {
        case 'referees':
            person = entry.person;
            extraFields.membershipNumber = entry.membershipNumber;
            e.membershipNumber = validators.membershipNumber(extraFields.membershipNumber)
            break;
        case 'parents':
            person = entry.person;
            extraFields.parentType = entry.parentType;
            e.parentType = validators.required(extraFields.parentType)
            break;
        case 'siblings':
            person = entry.person;
            extraFields.siblingType = entry.siblingType;
            e.siblingType = validators.required(extraFields.siblingType)
            break;
        case 'spouses':
            person = entry.person;
            extraFields.maritalStatus = entry.maritalStatus;
            e.maritalStatus = validators.required(extraFields.maritalStatus)
            break;
        case 'children':
            person = entry.person;
            extraFields.childType = entry.childType;
            e.childType = validators.required(extraFields.childType)
            break;
        case 'relatives':
            person = entry.person;
            extraFields.membershipNumber = entry.membershipNumber;
            ...
            e.membershipNumber = validators.membershipNumber(extraFields.membershipNumber)
            e.familyRelationship = validators.required(extraFields.familyRelationship)
            break;
        case 'beneficiaries':
            person = entry.person;
            extraFields.percentage = entry.percentage;
            extraFields.relationship = entry.relationship;
            e.percentage = validators.percentage(extraFields.percentage)
            e.relationship = validators.name(extraFields.relationship)
            break;
        default:
            person = entry.person;
    }
    
    e.person.firstName = validators.name(person.firstName)
    e.person.middleName = validators.optionalString(2)(person.middleName)
    e.person.lastName = validators.name(person.lastName)
    e.person.dob = validators.required(person.dob) || validators.dob(person.dob)
    e.person.lifeStatus = validators.required(person.lifeStatus)

    formErrors[arrayName][index] = e;
                        ...
                        <div className="col-sm-6 mb-3">
                            <div className="form-floating">
                                <input
                                    ...
                                    type={"text"}
                                    className={`form-control ${formErrors[arrayName][index].person.firstName ? 'is-invalid' : ''}`}
                        ...
                        <div className="col-sm-6 mb-3">
                            <div className="form-floating">
                                <input
                                    ...
                                    type={"text"}
                                    className={`form-control ${formErrors[arrayName][index].person.middleName ? 'is-invalid' : ''}`}
                        ...
                        <div className="col-sm-6 mb-3">
                            <div className="form-floating">
                                <input
                                    ...
                                    type={"text"}
                                    className={`form-control ${formErrors[arrayName][index].person.lastName ? 'is-invalid' : ''}`}
                        ...
                        <div className="col-sm-6 mb-3">
                            <div className="form-floating">
                                <input
                                    ...
                                    type={"date"}
                                    className={`form-control ${formErrors[arrayName][index].person.dob ? 'is-invalid' : ''}`}
                                    value={person.dob || ''}
                        ...
                        <div className="col-sm-6 mb-3">
                            <div className="form-floating">
                                <select 
                                    ...
                                    className={`form-select ${formErrors[arrayName][index].person.lifeStatus ? 'is-invalid' : ''}`} 
                            ...
                            <div className="col-sm-6 mb-3">
                                <div className="form-floating">
                                    <select
                                        ...
                                        className={`form-select ${formErrors[arrayName][index].maritalStatus ? 'is-invalid' : ''}`}
                                    >
                                        <option value="">-- Select --</option>
                            ...
                            <div className="col-sm-6 mb-3">
                                <div className="form-floating">
                                    ...
                                    onBlur={(e) => handleValidate(arrayName, index, 'childType', e.target.value)}
                                        ...
                                        className={`form-select ${formErrors[arrayName][index].childType ? 'is-invalid' : ''}`}
                                    >
                                        <option value="">-- Select --</option>
                            ...
                            <div className="col-sm-6 mb-3">
                                <div className="form-floating">
                                    <select
                                        ...
                                        className={`form-select ${formErrors[arrayName][index].parentType ? 'is-invalid' : ''}`}
                                    >
                                        <option value="">-- Select --</option>
                            ...
                            <div className="col-sm-6 mb-3">
                                <div className="form-floating">
                                    <select
                                        ...
                                        className={`form-select ${formErrors[arrayName][index].siblingType ? 'is-invalid' : ''}`}
                                    >
                                        <option value="">-- Select --</option>
                                ...
                                <div className="col-sm-6 mb-3">
                                    <div className="form-floating">
                                        <input
                                            ...
                                            type={"text"}
                                            className={`form-control ${formErrors[arrayName][index].membershipNumber ? 'is-invalid' : ''}`}
                                    ...
                                    <div className="col-sm-6 mb-3">
                                        <div className="form-floating">
                                            <select
                                                ...
                                                className={`form-select ${formErrors[arrayName][index].familyRelationship ? 'is-invalid' : ''}`}
                                            >
                                                <option value="">-- Select --</option>
                                ...
                                <div className="col-sm-6 mb-3">
                                    <div className="form-floating">
                                        <input
                                            ...
                                            type={"text"}
                                            className={`form-control ${formErrors[arrayName][index].relationship ? 'is-invalid' : ''}`}
                                    ...
                                    <div className="col-sm-6 mb-3">
                                        <div className="form-floating">
                                            <input
                                                ...
                                                className={`form-control ${formErrors[arrayName][index].percentage ? 'is-invalid' : ''}`}
                                            />
