...
const s = {
    ...
    avatar: { width:'150px', height:'150px', borderRadius:'50%', objectFit:'cover', border:'4px solid #667eea', boxShadow:'0 4px 20px rgba(102,126,234,0.3)' },
    ...
    previewBadge: { position:'absolute', bottom:'4px', right:'4px', background:'#667eea', color:'#fff', fontSize:'11px', fontWeight:'700', padding:'3px 8px', borderRadius:'20px' },
